                ...
                <VRow no-gutters align="center" justify="center">
                    <VCol cols="12" md="6" class="pa-3">
                        ...
                        <p class="text-medium-emphasis">
                            ป้อนอีเมล์และรหัสผ่านสำหรับเข้าใช้งาน
                        </p>
                        ...
                        <VForm class="mt-7" @submit.prevent="submit">
                            ...
                            <div class="mt-1">
                                ...
                                <VTextField v-model="password" :rules="[ruleRequired, rulePassLen]"
                        ...
                        <p class="text-center mt-10">
                            <span>ยังไม่ได้เป็นสมาชิก ?
                                <NuxtLink to="/signup" class="font-weight-bold text-primary">ลงทะเบียนที่นี่</NuxtLink>
                            </span>
                        </p>
                    </VCol>
                </VRow>
